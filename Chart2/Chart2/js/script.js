...
function createDefault2(data) {
  ...
  svg.selectAll("circle")
        ...
        .append("circle")
          ...
          .attr("cy", function(d) { return yScale(d.Renewables) })
          .attr("r", 4)
          .style("opacity", "0");
    ...
    d3
     ...
     .on("mouseover", function(event, d) {
       d3
        ...
        d3.select(".tooltip")
                .text(`Year: ${d.Date.getFullYear()}, Renewables consumed: ${d.Renewables}`)
      ...
      d3
       ...
       .on("mouseover", function(event, d) {
         d3
          ...
          d3.select(".tooltip")
            .text(`Year: ${d.Date.getFullYear()} ${this.className.baseVal} consumed: ${(
              () => {
                     ...
                     else if(this.className.baseVal == "Gas") return d.Gas;})(data.d)}`)
            .style("visibility", "visible")
            .style("top", (this.cy.baseVal.value + 100)+"px")
            .style("left", (this.cx.baseVal.value)+"px");
